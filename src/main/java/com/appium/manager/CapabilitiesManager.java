	...
	public DesiredCapabilities getCaps() throws IOException {
		...
		try {
			...
			case "Android":
				...
				String androidAppUrl = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "app" + File.separator + "gc.apk";
